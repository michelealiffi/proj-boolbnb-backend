    ...
    <div class="container">
            ...
            <div class="logo_laravel d-flex">
                <svg width="30" height="32" style="display: block;">
                    <path
                        ...
                        fill="currentcolor" data-darkreader-inline-fill="" class="header-brand-color">
                    </path>
                    <div class="header-brand-color fw-bold ms-2"> boolbnb </div>
                </svg>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link fw-semibold" href="{{ url('/') }}">{{ __('Home') }}</a>
                </li>
            </ul>

            <!-- Right Side Of Navbar -->
            <ul class="navbar-nav ml-auto border border-2 rounded-5 shadow-sm">
                <div class="container-fluid">
                    <div class="dropdown">
                        <button class="nav-link dropdown-toggle" type="button" href="#" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="navbar-toggler-icon"></span>
                            <span class="fa-solid fa-user fa-lg ms-1"></span>
                        </button>
                        <ul class="dropdown-menu border border-2 rounded-4 bg-white">
                            <!-- Authentication Links -->
                            @guest
                                <li class="nav-item">
                                    <a class="dropdown-item fw-semibold" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
